...
class RealMeAuthenticator extends Authenticator {
	 ...
	 *
	 * @todo Implement this - needs to check certs are in place, vendor-specific Real Me details are inserted etc.
	...
	public static function get_name() {
		return _t('RealMeAuthenticator.TITLE', 'Real Me Account');
	}
}